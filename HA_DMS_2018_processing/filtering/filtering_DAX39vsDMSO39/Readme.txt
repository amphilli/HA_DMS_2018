1. In the main directory (filtering_DAX39vsDMSO39/)
...
Rep1_DAX39_mutdiffsel.txt
Rep2_DAX39_mutdiffsel.txt
Rep3_DAX39_mutdiffsel.txt
...
2. In the compare directory (filtering_DAX39vsDMSO39/compare)
