1. In the main directory (filtering_DAX39vsDAX37/)
...
Rep1_DAX_37v39_mutdiffsel.txt
Rep2_DAX_37v39_mutdiffsel.txt
Rep3_DAX_37v39_mutdiffsel.txt
...
2. In the compare directory (filtering_DAX39vsDAX37/compare)
